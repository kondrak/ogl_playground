...
{
    // view matrix
    Renderer::MakeView( m_viewMatrix, m_position, m_viewVector, m_upVector );
}
...
void Camera::UpdateProjectionMatrix()
{
    ...
    case CAM_FPS:
        ...
        {
            Renderer::MakePerspective( m_projectionMatrix, g_renderContext.fov, g_renderContext.scrRatio, g_renderContext.nearPlane, g_renderContext.farPlane );
        }
        else
        {
            Renderer::MakePerspective( m_projectionMatrix, g_renderContext.fov * 1.f / g_renderContext.scrRatio, g_renderContext.scrRatio, g_renderContext.nearPlane, g_renderContext.farPlane );
        }
        break;
    case CAM_ORTHO:
        Renderer::MakeOrthogonal( m_projectionMatrix, g_renderContext.left, g_renderContext.right, g_renderContext.bottom, g_renderContext.top, 0.1f, 5.f );
        break;
    }
}
